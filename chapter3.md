...
`@sct`
```{r}
msg1 <- "Попробуйте ещё раз. Внимательно смотрите на насыщенность кругов у соответствующих переменных."
msg2 <- "Правильно!"
msg4 <- "Попробуйте ещё раз. Внимательно смотрите на насыщенность кругов у соответствующих переменных."
msg3 <- "Попробуйте ещё раз. Внимательно смотрите на насыщенность кругов у соответствующих переменных."
...
#General
test_error()
success_msg("Прекрасно! В следующем упражнении Вы сможете отобразить построенный Вами интервал на графике.")
```
...
`@hint`
В качестве `xintercept` установите загруженные переменные `lower` и `upper`, а цвет установите равным _red_.
