...
- Посчитайте количество наблюдений в датасете, для этого используйте функцию nrow(). Полученный результат сохраните в переменную num_observ; 
- Посчитайте несмещенную выборочную дисперсию продолжительности извержения гейзера по формуле. Полученный результат сохраните в переменную var_eval и выведите его на экран с помощью функции print();
- Посчитайте несмещенную выборочную дисперсию продолжительности извержения гейзера с помощью фунции var(). Полученный результат сохраните в переменную var_erupt и выведите его на экран с помощью функции print(). Сравните полученные результаты.  
