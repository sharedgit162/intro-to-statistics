...
* Пришло время расширить ваши вычислительные возомжности. Рассчитайте вероятность $P(X=1)$, используя формулу, приведённую в таблице. Биномиальный коэффициент $C_{n}^k$ можно найти при помощи команды `choose(n, k)`.
