...
test_error()
success_msg("Отлично! Теперь Вы убедились, что значение дисперсии, рассчитанное по общей формуле, совпадает со значением, полученным из формулы из определения.")
```
