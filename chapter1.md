...
* Посчитайте математическое ожидание Хи-квадрат распределения с 3 степенями свободы. Для этого вспомните формулу математического ожидания в непрерывном случае: $E(X) = \int_{-/infty}^{+/infty} x f_X (x) dx$
