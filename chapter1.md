---
  ...
  description: "В вводной главе курса мы вспомним основы теории вероятностей и рассмотрим реализацию основных функций в R. В первой части главы мы произведем краткий обзор дискретных распределений, а во второй - непрерывных, а также рассмотрим основные характеристики случайных величин и их зависимости."
  v2: true
