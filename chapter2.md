...
`@hint`
- Отсортируйте значения времени ожидания в порядке возрастания. Затем сгенерируйте значения функции распределения. В данном случае они лежат в интервале $[\fraq{1}{n},1]$.
