...
`@hint`
- Отсортируйте значения времени ожидания в порядке возрастасния. Затем сгенерируйте значения функции распределения. В данном случае они лежат в интервале $[\fra{1}{n},1]$.
