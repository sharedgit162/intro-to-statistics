...
`@feedbacks`
- В общем случае, для каждой конкретной выборке в границы доверительного интервала может попасть различное число наблюдений. Ва важно оценить, как часто в эти границы попадает неизвестный параметр.
- Неизвестный параметр, который вы пытаетесь оценить, принимает одно единственное значение.
- Замечательно! Вы верно понимаете смысл доверительного интервала. Теперь самое время построить его!
...
#Посчитатйе границы доверительного интервала. 
low <- ___
